...
@ddt
class GiveupGoodsListCase(unittest.TestCase):
    '''赠送专区'''
    excel = ReadExcel(os.path.join(DATA_DIR, 'jc_api.xlsx'), 'giveup_goods_list')
    ...
    @data(*cases)
    def test_case_giveup_goods_list(self, case):
        url = apiURL + case.url
        method = case.method
