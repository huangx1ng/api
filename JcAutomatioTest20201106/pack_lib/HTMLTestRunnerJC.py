...
"""
    ...
    <div class='page-header'>
        <h1>%(title)s</h1>
    <div id="chart"style="width:30%%;height:200px;float:right;"></div>
    %(parameters)s
    <div style="float: left;width:50%%;"><p class='description'>%(description)s</p></div>
    </div>
    <div id="chartline" style="width:50%%;height:2px;float:right;"></div>
    <div id="chart"style="width:50%%;height:2px;float:left;"></div>
